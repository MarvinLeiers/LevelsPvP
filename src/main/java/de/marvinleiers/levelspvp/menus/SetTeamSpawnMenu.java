...
public class SetTeamSpawnMenu extends Menu
{
    private Game game;

    public SetTeamSpawnMenu(Game game, MenuUserInformation menuUserInformation)
    {
    ...
    public void handleClickActions(InventoryClickEvent inventoryClickEvent)
    {
        ...
        LevelsPvP.getApi().gamesConfig.setLocation("games." + game.getName() + ".teams." + team + ".spawn", player.getLocation());
